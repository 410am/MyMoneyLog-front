      ...
      <div className="min-h-screen">
        <main className="max-w-2xl mx-auto px-4 py-6 space-y-6">
          ...
          {!edit ? (
            ...
            "
                >
                  ...
                  />
                  <div
                    className="w-10 h-10 rounded-xl bg-slate-500 hover:opacity-90 flex justify-center items-center
                    absolute inset-0 opacity-0 "
                    onClick={() => fileInputRef.current?.click()}
                  >
                    <EditIcon fontSize="inherit" className="text-slate-50 " />
                  </div>
          ...
          <div className="space-y-2 grid grid-rows-2 justify-items-center">
            <Button variant="outline" className="w-2/5" onClick={handleLogout}>
              로그아웃
            </Button>
